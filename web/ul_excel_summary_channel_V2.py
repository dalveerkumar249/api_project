...
def get_global_sales_data(input_values):
    ...
    select_query = """select ctry_name, div_desc, catg_desc, subcat_desc, chnl_desc,global_chnl_name, MONTH_YEAR, sum(SALES_VALUE) 
            from (select
                    f.ctry_name,
                    c.div_desc,
                    e.catg_desc,
                ...
                group by b.subcat_desc, e.catg_desc, f.ctry_name, c.div_desc, g.chnl_desc, g.global_chnl_name, quarter(a.period_ending_date) 
            union 
            select
                f.ctry_name,
                c.div_desc,
            ...
            where JSON_VALUE(a.RECORDSET_CONTENTS_JSON, '$.RECORD_TYPE') = 'FORECAST' 
              ...
              and year(a.period_ending_date) in (?, ?, ?, ?)  
            group by b.subcat_desc, e.catg_desc, f.ctry_name, c.div_desc, chnl_desc, g.global_chnl_name,quarter(a.period_ending_date) 
                  ) 
            group by MONTH_YEAR, ctry_name, div_desc, catg_desc, subcat_desc, chnl_desc,global_chnl_name
...
def ul_db_excel_summary_report(parameters):
    ...
    column_names = ["COUNTRY","DIVISION","CATEGORY","SUB_CATEGORY","CHANNEL","GLOBAL_CHANNEL","MONTH_YEAR","VALUE"]
    ...
    #print("\nPivoting...")
    baselinep_DF = pd.pivot_table(baseline_DF,index=["COUNTRY","DIVISION","CATEGORY","SUB_CATEGORY","CHANNEL","GLOBAL_CHANNEL"],columns='MONTH_YEAR',values='VALUE')
    longcovidp_DF = pd.pivot_table(longcovid_DF_new,index=["COUNTRY","DIVISION","CATEGORY","SUB_CATEGORY","CHANNEL","GLOBAL_CHANNEL"],columns='MONTH_YEAR',values='VALUE')
    roip_DF = pd.pivot_table(roi_DF_new,index=["COUNTRY","DIVISION","CATEGORY","SUB_CATEGORY","CHANNEL","GLOBAL_CHANNEL"],columns='MONTH_YEAR',values='VALUE')
        ...
        #{
                    ...
                    for catg_name in category_list:
                        ...
                        #{
                            ...
                            #{
                                ...
                                tempDF9.at[df_len, 'GLOBAL_CHANNEL'] = "Total"
            ...
            for div_name in div_list:
                ...
                if tempDF5.shape[0] >1:
                    ...
                    tempDF5.at[df_len, 'GLOBAL_CHANNEL'] = "Total"
    ...
    #final_DF2.to_excel("summary_channel.xlsx")
