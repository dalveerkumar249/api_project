...
#        
        ...
        filename = './total_level/PRICE_Prediction_'+str(int(SUBCAT))+"_"+str(int(CHNL))+"_"+str(int(FMT))+"_"+str(int(REG))
...
#        print("REGION ",REG)
        ...
        filename = './total_level/TDP_Prediction_'+str(int(SUBCAT))+"_"+str(int(CHNL))+"_"+str(int(FMT))+"_"+str(int(REG))
        model = joblib.load(filename)
...
#        plt.show()
    ...
    df = pd.DataFrame()
    df['DATE'] = DATAF_ALL['PERIOD_ENDING_DATE']
    df['SALES_PREDICTION'] = predictions
...
#DATAF_ALL_HIST_PROJ_SALES = pd.read_excel('./Predictions_soy_sauce_tea.xlsx',engine = 'openpyxl',sheet_name = "359")
#DATAF_ALL_HIST_PROJ_SALES['CONSUMER_PRICE_INDEX'] = 100.0
#simulation(DATAF_ALL_HIST_PROJ_SALES,1,0,'catdim359')