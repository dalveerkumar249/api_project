...
def Simulation_Function_MX_Total(dataDF,price_flag,tdp_flag):
    ...
    price_cfg= pd.read_excel("./mx_models/MX_Model_Variables.xlsx",sheet_name='PRICE')
    tdp_cfg= pd.read_excel("./mx_models/MX_Model_Variables.xlsx",sheet_name='TDP')
    sales_cfg= pd.read_excel("./mx_models/MX_Model_Variables.xlsx",sheet_name='SALES')
    model_cfg= pd.read_excel("./mx_models/MX_Model_Variables.xlsx",sheet_name='MODEL_NAME')
...
#    DATAF.rename(columns = {'AVG_TEMP_CELSIUS':'AVG(AVG_TEMP_CELSIUS)','HUMID_PCT':'AVG(HUMID_PCT)'},inplace =True)
    ...
    if (price_flag==0):
        ...
        filename = './mx_models/Price_Total_Prediction_'+str(SUBCAT)+"_"+str(CHNL)+"_"+str(FMT)+"_"+str(REG)
    ...
    if tdp_flag==0:    
        ...
        filename = './mx_models/TDP_Total_Prediction_'+str(SUBCAT)+"_"+str(CHNL)+"_"+str(FMT)+"_"+str(REG)
...
testing_data = pd.read_csv('DATAF_ALL_HIST_PROJ_SALES_SCENARIO_1_SUBCAT_2.csv')

testing_data = pd.read_csv('DATAF_ALL_HIST_PROJ_SALES_SCENARIO_1_SUBCAT_1_3_4.csv')

testing_data = pd.read_csv('DATAF_ALL_HIST_PROJ_SALES_SCENARIO_1NEW_SUBCAT_5_6_7.csv')



testing_data.index = range(len(testing_data))
testing_data.columns
testing_data=testing_data[testing_data['SUBCAT_CD']==7]
...
output = Simulation_Function_MX_Total(testing_data,0,0)
